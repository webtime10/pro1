...
@include('admin.partials.oc-page-header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Создание', 'url' => route('admin.categories.create')],
    ],
])
<section class="content pt-0">
    @include('admin.partials.oc-form-toolbar', ['formId' => 'categoryForm', 'backUrl' => route('admin.categories.index')])
            ...
            <div class="oc-panel-body">
                            ...
                            <form id="categoryForm" action="{{ route('admin.categories.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="column" id="column" class="form-control" value="{{ old('column', 1) }}" min="0" max="12" style="max-width: 12rem;">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="mr-3"><input type="checkbox" name="top" value="1" {{ old('top') ? 'checked' : '' }}> Главное меню (top)</label>
